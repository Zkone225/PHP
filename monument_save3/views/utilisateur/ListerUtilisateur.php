...
<head>
	...
	<meta charset="UTF-8">
	<title>Utilisateurs de Paris</title>
			...
			<table class="w3-table w3-striped w3-border w3-hoverable w3-small">
				...
				<tbody>
					...
					<tr>
						...
						<td>
						    <a href="../../controllers/utilisateur/UtilisateurChercher.php?idUtilisateur=<?php echo $utilisateur['id_utilisateur']; ?>&traitement=1"><button class="w3-btn w3-blue w3-round-large w3-hover-green w3-small"><i class="fa fa-eye" ></i>&nbsp;&nbsp;Voir</button></a>&nbsp;&nbsp;
