...
//-------------------------------------------------------------------------------------------------------------
	...
	function utilisateur_Insert( $email, $mdp, $user_type ) {
		...
		// prepare requête sql 
		$reqSql = "insert into utilisateur values (:vUserId, :vEmail, :vMdp, :vUser_type)";
		...
		try{
			...
			$stmt->bindParam(':vEmail', $vNomMonument, PDO::PARAM_STR);
			$stmt->bindParam(':vMdp', $vMdp, PDO::PARAM_STR);
			$stmt->bindParam(':vUser_type', $User_type, PDO::PARAM_STR);
...
//--------------------------------------------------------------------------------------------------------	
	...
	function utilisateur_Update( $id, $email, $mdp, $user_type ) {
		...
		// prepare requête sql 
		$reqSql = "update monument set email_utilisateur = :vEmail, " .
