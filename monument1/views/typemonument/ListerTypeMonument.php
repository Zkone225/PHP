			...
			<table class="w3-table w3-striped w3-border w3-hoverable w3-small">
				...
				<tbody>
					...
					<td></td>
						...
						<td>
						<a href="../../controllers/typemonument/TypeMonumentChercher.php?idtypemonument=<?php echo $ligne['ID_TYPE_Monument'] ?>&traitement=1"><button class="w3-btn w3-blue w3-round-large w3-hover-green w3-small"><i class="fa fa-eye" ></i>&nbsp;&nbsp;Voir</button></a>&nbsp;&nbsp;
						...
						<a href="../../controllers/typemonument/TypeMonumentChercher.php?idtypemonument=<?php echo $ligne['ID_TYPE_Monument'] ?>&traitement=3"><button class="w3-btn w3-red w3-round-large w3-hover-green w3-small"><i class="fa fa-trash" ></i>&nbsp;&nbsp;Supprimer</button></a>
						</td>
					</tr>
					<?php
						...
						<tr>
							<td></td>
							<td><label class="w3-text-red">La liste est vide. Aucun type de monument saisi</label></td>
							<td></td>
						</tr>
						<?php
					}
