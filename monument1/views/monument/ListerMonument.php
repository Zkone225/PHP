			...
			<table class="w3-table w3-striped w3-border w3-hoverable w3-small">
				...
				<tbody>
					...
					<tr>
						...
						<td>
						<a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=1"><button class="w3-btn w3-blue w3-round-large w3-hover-green w3-small"><i class="fa fa-eye" ></i>&nbsp;&nbsp;Voir</button></a>&nbsp;&nbsp;
						...
						<a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=4"><button class="w3-btn w3-grey w3-round-large w3-hover-green w3-small"><i class="fa fa-download" ></i>&nbsp;&nbsp;Télécharger Images</button></a>
						</td>
