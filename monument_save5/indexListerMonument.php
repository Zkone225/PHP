				...
				<tbody>
					...
					<tr>
						...
						<td><a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=1"><button class="w3-btn w3-blue w3-round-large w3-hover-green w3-small"><i class="fa fa-eye" ></i>&nbsp;&nbsp;Voir</button></a>&nbsp;&nbsp;
							...
							<a href="../../views/monument/frmupload.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=4&nomMonument=<?php echo $monument['Nom_Monument']; ?>"><button class="w3-btn w3-red w3-round-large w3-hover-green w3-small"><i class="fa fa-download" ></i>&nbsp;&nbsp;Télécharger l'image</button></a></td>&nbsp;&nbsp;
						</td>
					</tr>
					<?php
						} } else { ?>
