...
<body >
<a href="../monument/indexListerMonument.php"><button class="w3-btn w3-red w3-round-large w3-hover-green w3-small"><i class="" ></i>&nbsp;&nbsp;Les monuments de Paris</button></a>&nbsp;&nbsp;
<p style="text-align:right">
<a href="../../monument/controllers/deconnexion/deconnexion.php"><button class="w3-btn w3-red w3-round-large w3-hover-green w3-small"><i class="" ></i>&nbsp;&nbsp;Déconnexion</button></a>&nbsp;&nbsp;
	</p>

<span style="text-align:center; margin-top:150px">
