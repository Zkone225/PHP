...
<body>
	...
	<div class="w3-container">
			...
			<table class="w3-table w3-striped w3-border w3-hoverable w3-small">
				...
				<tbody>
					...
					<td><img id="img_monument" src="../../image/monument/monument_<?php echo $monument['ID_Monument'].".png"; ?>"alt="photo du monument" /></td>
						...
						<td><a href="../../controllers/monument/MonumentChercher.php?idMonument=<?php echo $monument['ID_Monument']; ?>&traitement=1"><button class="w3-btn w3-blue w3-round-large w3-hover-green w3-small"><i class="fa fa-eye" ></i>&nbsp;&nbsp;sélèctionner</button></a>&nbsp;&nbsp;
						</td>
					</tr>
					<?php
						} } else { ?>
		...
		<footer class="w3-brown w3-padding-large">
			<a href="frmMonumentCreer.php" >&nbsp;&nbsp;<button class="w3-btn w3-teal w3-round-large w3-hover-green w3-medium"><i class="fa fa-plus-circle" ></i>&nbsp;&nbsp;Inaugurer Ajouter</button></a>
